...
class CommentsHandler:
    ...
    def _initialize_db(self):
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS comments (
                ...
                video_filename TEXT NOT NULL,  -- Renamed to match LikesHandler and VideosHandler (filename)
    ...
    def get_comments(self, payload):
        ...
        try:
            ...
            comments = [{"username": row[0], "content": row[1], "timestamp": row[2]} for row in comments_data]
